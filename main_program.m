...
clear all
initial_data  = "database_CO2_DOIs_modified_17082023.xml"; 
...
%     Khu_Far (every_pressure,string_name_KhuFar) %compute and plot characteristics
    ...
    string_name_NIST_CHAR_1  = strcat("NIST_CHAR_DATA1_CO2_18082023",string(every_pressure),".xml");
    string_name_NIST_TP_1   = strcat("NIST_TP_DATA1_CO2_18082023",string(every_pressure),".xml");
    ...
    string_name_NIST_CHAR_2 = strcat("NIST_CHAR_DATA2_CO2_18082023", string(every_pressure),".xml");
    string_name_NIST_TP_2 = strcat("NIST_TP_DATA2_CO2_18082023", string(every_pressure),".xml");
